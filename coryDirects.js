...
var config = {
	title: 'Work Items and Story Points Report - By Assignee / Month',
	query: "assignee IN (" + teams[manager].toString() + ") AND resolutiondate >= startOfYear() ORDER BY resolutiondate ASC",
	// query: "assignee IN (" + teams[manager].toString() + ") AND resolutiondate >= startOfMonth() ORDER BY resolutiondate ASC",
	// query: "resolutiondate >= startOfYear() ORDER BY resolutiondate ASC",
	options: {
		startAt: 0,
		maxResults: 100,
